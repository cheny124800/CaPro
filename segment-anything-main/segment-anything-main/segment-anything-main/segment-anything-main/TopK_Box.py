...
# 定义文件夹路径
input_dir = r"C:\Users\86181\Desktop\cvpr25\R-CenterNet-master_OOO\R-CenterNet-master\imgs"  # 目标文件夹路径
txt_O_dir = r"C:\Users\86181\Desktop\sim2teal\OCT1600\origin_txt"  # txt文件所在目录
output_dir = r"C:\Users\86181\Desktop\sim2teal\OCTA1600\top45_result"  # 输出文件夹路径（确保该路径已存在）
txt_selected_dir = r"C:\Users\86181\Desktop\sim2teal\OCT1600\top45_txt"  # 保存Selected txt文件的目录
            ...
            for i, line in enumerate(f):
                ...
                if square_size > 0:  # 确保裁剪区域有正方形大小
                    ...
                    if (x2_crop - x1_crop) == (y2_crop - y1_crop) and (x2_crop - x1_crop) > 0:
                        ...
                        value = Box_judging.SAM_check(cropped_image_path)  # 假设你已经导入Box_judging
                        # 将value和对应的索引i保存到列表
