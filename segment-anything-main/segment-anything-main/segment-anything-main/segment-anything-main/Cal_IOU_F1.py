...
def calculate_metrics(predict_dir, gt_dir):
    ...
    for file_name in predict_files:
        if file_name.endswith('.png'):
            ...
            # 生成真实掩码文件名
            gt_file_name = file_name.replace('_mask_vitb.png', '.png')
...
# 设置文件夹路径
predict_dir = r'C:\Users\86181\Desktop\sim2teal\test\top15_output'
gt_dir = r'C:\Users\86181\Desktop\sim2teal\OCTA500\all\test_label'
