            ...
            with open(json_file, 'r', encoding='UTF-8') as fp:
                ...
                for p in fp:
                    ...
                    if 'filename' in p:
                        ...
                        f_name = 0
                        self.path = os.path.join(path, r'C:\Users\86181\Desktop\cvpr25\FreeCOS-main\FreeCOS-main\FDA_RGB\FDA_retinalIOSTAR_rgbimage', self.filen_ame.split('.')[0] + '.jpg')
                    if 'width' in p:
...
xml_file = glob.glob(r'C:\Users\86181\Desktop\cvpr25\RoLabelImg_Transform-master\RoLabelImg_Transform\xml/*.xml')

# xml_file=['./Annotations/000032.xml']
#xml_file=['00000007_05499_d_0000037.xml']
PascalVOC2coco(xml_file, '../data/airplane/annotations/train.json')
