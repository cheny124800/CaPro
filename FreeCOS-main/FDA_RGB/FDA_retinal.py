...
txt_src_files = r"C:\Users\86181\Desktop\cvpr25\FreeCOS-main\FreeCOS-main\Data\CrackTree\txt_data"
tar_file = r"C:\Users\86181\Desktop\sim2teal\DeepCrack\train\img"
src_file = r"C:\Users\86181\Desktop\cvpr25\FreeCOS-main\FreeCOS-main\Data\CrackTree\fake_gtvessel_thin"
Save_image = "./FDA_retinalIOSTAR_rgbimage/"
Save_label = "./FDA_retinalIOSTAR_rgblabel/"
Save_xml = "./FDA_retinalIOSTAR_rgbxtxt/"
...
for i in range(len(files_src)):
    ...
    for j in range(len(tarlist)):
        ...
        save_image_path = Save_image + str(counter) + ".jpg"
        save_label_path = Save_label + str(counter) + ".gif"
        ...
        if p_constrast>0.7:
            Contrast = np.random.uniform(0.82, 0.90)
        ...
        if os.path.exists(txt_src_files):
            # 复制 XML 文件到目标目录
            xml_dest_path = os.path.join(Save_xml, str(counter) + ".txt")
